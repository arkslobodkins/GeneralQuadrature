...
/* The workhorse.
/**/
int GaussMaster(n, alpha, beta, conflag, abscis, weight)
int n;
double alpha, beta;
int conflag;
...
/**/
int QQp(t, poly, deriv)    /* not exported, hence static jtdeb static creates error, hence deleted*/
double t;
double *poly, *deriv;
{
    int k;
